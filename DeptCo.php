...
<body>
	...
	<div class="container-xl" style="background-color: LightGray;">
		...
		<?php
		echo "Project Co-ordinator of $deptname" ;
		 ?>
...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Div Co-ordinator Preference</a>
      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">View Under Your Project</a>
      <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Project Domains faculty wise</a>
       <a class="nav-link" id="v-pills-shubham-tab" data-toggle="pill" href="#v-pills-shubham" role="tab" aria-controls="v-pills-shubham" aria-selected="false">Select Your Own Domain</a>
	...
	echo "<table class='table'>
			  <thead class='thead-light'>
			    <tr>
			      ...
			      <th scope='col' width='250px'>Division Co-ordinator Name</th>
...
$sql11    = "SELECT * FROM logins where roles='DiviCo' and dept='$deptname'";
            $result11 = mysqli_query($conn,$sql11) or die(mysql_error());
            while ($row11   = mysqli_fetch_array($result11))
            {
				  ...
				  echo " <tr> ";
				     echo "<td>" .$row11['dept']. "</td>";
				     echo "<td>" .$row11['names']. "</td>";
				     echo "<td>" .$row11['divi']. "</td>";
					 echo "<td>" .$row11['emails']. "</td>";
...
<hr/>
			...
			<form action='DeptCo11.php' method='post'>
<center>
...
<!--end 3rd Opetion here-->

<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
	
			<form action='DeptCo12.php' method='post'>
<center>
...
$sql2    = "SELECT * FROM domainsf where dept='$deptname' ";
            $result2 = mysqli_query($conn,$sql2) or die(mysql_error());
            while ($row2   = mysqli_fetch_array($result2))
            {
...
<br/><br/><br/>
          ...
          <div class="tab-pane fade" id="v-pills-shubham" role="tabpanel" aria-labelledby="v-pills-shubham-tab">
          	
			<form action='DeptCo13.php' method='post'>
<center>
		<button type="submit" class="btn btn-primary">Add New Domain</button>
</center></form><br/>
