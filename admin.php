...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Preference</a>
	...
	echo "<table class='table'>
			  <thead class='thead-light'>
			    <tr>
			      ...
			      <th scope='col' width='250px'>Project Co-ordinator Name</th>
...
$sql11    = "SELECT * FROM logins where roles='DeptCo'";
...
<hr/>
			...
			<form action='admin11.php' method='post'>
<center>
